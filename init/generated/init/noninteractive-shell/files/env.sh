...
export NONINTERACTIVE_SHELL_PREFIX NONINTERACTIVE_SHELL_STATE NONINTERACTIVE_SHELL_CACHE NONINTERACTIVE_SHELL_BIN_HOME NONINTERACTIVE_SHELL_SHARE_HOME
