# generated domain runtime metadata: generated/init/interactive-shell
# shellcheck shell=sh

DOMAIN_ID='generated/init/interactive-shell'
...
zshenv-parse|test -f $HOME/.zshenv && zsh -n $HOME/.zshenv|fatal
zshrc-parse|test -f $HOME/.zshrc && zsh -n $HOME/.zshrc|fatal
